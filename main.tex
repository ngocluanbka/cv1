...
\phone[mobile]{+84~0165~9854~6822}                   % optional, remove / comment the line if not wanted
...
\cventry{Oct2015 Jan2017}{Intership}{High Performance Computing Center, HUST}{Hanoi}{}{I have been following my lecturer and joined ICSE as an intern.\newline{}%
...
\item IoT Platform Dashboard
  ...
  \end{itemize}
\end{itemize}}
\cventry{Jan2015 July2015}{Intership}{Viettel Software}{Hanoi}{}{Viettel Software was my first company, then I respect all the time and knowledge that I learnt when I worked there.
\newline{}  
Detailed achievements:%
  \begin{itemize}%
...
\cvitemwithcomment{English}{500 Toeic}{}

\section{Computer skills}
\cvitem{Language}{Python,PHP, HTML, CSS}
\cvitem{IDE}{Pycharm, SublimeText, Eclipse}
\cvitem{Database}{MySQL, InfluxDB}
\cvitem{Tools}{Git, Docker, Kubernetes}

\section{Adwards and Scholarships}
\cvitem{Nov2015}{Third prize in UET Hackathon Competition}
\cvitem{2012}{Second prize in the Provincial Level Contest of Physics for High School Students}
